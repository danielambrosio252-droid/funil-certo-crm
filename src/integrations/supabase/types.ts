  ...
  public: {
    Tables: {
      ...
      whatsapp_flow_edges: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_flow_edges_flow_id_fkey"
            columns: ["flow_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "whatsapp_flow_edges_source_node_id_fkey"
            columns: ["source_node_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_flow_nodes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "whatsapp_flow_edges_target_node_id_fkey"
      ...
      whatsapp_flow_executions: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_flow_executions_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "whatsapp_flow_executions_current_node_id_fkey"
          ...
          {
            foreignKeyName: "whatsapp_flow_executions_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "funnel_leads"
            referencedColumns: ["id"]
      ...
      whatsapp_flow_nodes: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_flow_nodes_flow_id_fkey"
            columns: ["flow_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_flows"
            referencedColumns: ["id"]
